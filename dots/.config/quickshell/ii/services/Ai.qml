...
Singleton {
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        "gemini-2.5-flash": aiModelComponent.createObject(this, {
            ...
            "description": Translation.tr("Local service | Gemini web app via gemini-webapi\nUses your Gemini web login and supports enabled Gemini extensions."),
            "homepage": "http://127.0.0.1:8765/health",
            "endpoint": "http://127.0.0.1:8765/v1/chat/completions",
            "model": "gemini-3-flash",
            "requires_key": false,
            "key_id": "gemini",
            "key_get_link": "https://gemini.google.com",
            "key_get_description": Translation.tr("This local service uses Gemini web cookies, not an AI Studio API key."),
            "api_format": "openai",
        }),
        "gemini-3-flash": aiModelComponent.createObject(this, {
            "name": "Gemini 3 Flash (local web)",
            "icon": "google-gemini-symbolic",
            "description": Translation.tr("Local service | Gemini web app via gemini-webapi\nUse @Google Calendar, @Gmail, etc. after enabling extensions on gemini.google.com."),
            "homepage": "http://127.0.0.1:8765/health",
            "endpoint": "http://127.0.0.1:8765/v1/chat/completions",
            "model": "gemini-3-flash",
            "requires_key": false,
